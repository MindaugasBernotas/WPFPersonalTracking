...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=.; Database=PERSONELTRACKING; trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Emploee>(entity =>
            {
                ...
                entity.HasOne(d => d.Department)
                    ...
                    .HasConstraintName("FK_EMPLOEE_DEPARTMENT");

                entity.HasOne(d => d.Position)
                    .WithMany(p => p.Emploees)
                    .HasForeignKey(d => d.PositionId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_EMPLOEE_POSITION");
            });
            ...
            modelBuilder.Entity<Permission>(entity =>
            {
                ...
                entity.Property(e => e.PermissionStartDay).HasColumnType("date");

                entity.HasOne(d => d.Employee)
                    .WithMany(p => p.Permissions)
                    .HasForeignKey(d => d.EmployeeId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_PERMISSION_EMPLOEE");
            ...
            modelBuilder.Entity<Salary>(entity =>
            {
                ...
                entity.HasOne(d => d.Employee)
                    ...
                    .HasForeignKey(d => d.EmployeeId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_SALARY_EMPLOEE");
            ...
            modelBuilder.Entity<Task>(entity =>
            {
                ...
                entity.Property(e => e.TraskDeliveryDate)
                    .HasColumnType("date")
                    .HasColumnName("TRaskDeliveryDate");

                entity.HasOne(d => d.Employee)
                    .WithMany(p => p.Tasks)
                    .HasForeignKey(d => d.EmployeeId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_TASK_EMPLOEE");
